...
#ifndef ASTARTE_DEVICE_SDK_DEVICE_ID_H
#define ASTARTE_DEVICE_SDK_DEVICE_ID_H
 ...
 *
 * @param[in] nsp The namespace used to generate the device ID.
...
astarte_result_t astarte_device_id_generate_deterministic(
    const uint8_t nsp[ASTARTE_DEVICE_ID_NAMESPACE_SIZE], const uint8_t *name, size_t name_size,
...
#endif // ASTARTE_DEVICE_SDK_DEVICE_ID_H

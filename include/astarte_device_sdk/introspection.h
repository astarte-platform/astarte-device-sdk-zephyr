...
#ifndef ASTARTE_DEVICE_SDK_INTROSPECTION_H
#define ASTARTE_DEVICE_SDK_INTROSPECTION_H
 ...
 *
 * @details An empty string is returned if not interfaces got added with #introspection_add
...
#endif // ASTARTE_DEVICE_SDK_INTROSPECTION_H

 ...
 */
static astarte_result_t byte_array_init(
    astarte_bson_serializer_t *bson, const void *bytes, size_t size);
/**
    ...
    astarte_bson_serializer_t *bson, const char *name, int64_t epoch_millis)
{
    ...
    uint8_t val_buf[sizeof(int64_t)] = { 0 };
    int64_to_bytes(epoch_millis, val_buf);
